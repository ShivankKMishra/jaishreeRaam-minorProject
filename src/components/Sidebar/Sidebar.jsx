  ...
  return (
    <aside className={`rounded-2xl m-2 bg-slate-200 text-orange-400 h-screen fixed transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      <div className="w-full p-6 m-4">
        ...
        <Link to="/Home" className="w-full flex items-center justify-start my-8 hover:font-serif m-1 p-1 text-orange-400 hover:bg-orange-400 hover:text-white rounded-lg"> {/* Use Link component with 'to' attribute */}
                <HomeIcon /> Classroom
              </Link>
